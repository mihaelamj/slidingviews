...
#define BUTTON_ACTION_EDIT @"Edit"
#define BUTTON_ACTION_DONE @"Done"
...
- (void)addBarButton
{
    UIBarButtonItem *editButton = [[UIBarButtonItem alloc] initWithTitle:BUTTON_ACTION_EDIT style: UIBarButtonItemStyleBordered target:self action:@selector(editButton:)];
...
- (void)editButton:(id)sender
{
    if (self.editing) {
        ...
        [self.navigationItem.rightBarButtonItem setTitle:BUTTON_ACTION_EDIT];
        ...
        [self.tableView reloadData];
        [self.navigationItem.rightBarButtonItem setTitle:BUTTON_ACTION_DONE];
